		...
		<>
					...
					<Grid container justify={'space-between'}>
						<Grid className={classes.gridItem} item xs>
							<Typography className={classes.typography} variant={'h5'} component={'h5'}>
								<Box component={'span'} ml={1}>{'이용약관'}</Box>
							</Typography>
						</Grid>
					</Grid>
				</Container>
			...
			<Container className={classes.contentContainer}>
				...
				<List>
					...
					<ListItem>
						<Box>
							<Box>{'② 제1항과 같이 회원으로 가입할 것을 신청한 자가 다음 각 호에 해당하지 않는 한 신청한 자를 회원으로 등록합니다.'}</Box>
							<Box mt={1} ml={2}>{'1. 등록 내용에 허위, 기재누락, 오기가 있는 경우'}</Box>
							<Box mt={1} ml={2}>{'2. 기타 회원으로 등록하는 것이 개념글 저장소의 서비스 운영 및 기술상 현저히 지장이 있다고 판단되는 경우'}</Box>
						</Box>
					</ListItem>
				</List>
				<Typography variant={'h6'} component={'h6'}>
				...
				<List>
					...
					<ListItem>
						<Box>
							<Box>{'③ 회원이 다음 각 호의 사유에 해당하거나 제12조 규정에 위반되는 경우, 개념글 저장소는 회원의 회원자격을 적절한 방법으로 제한 및 정지, 상실시킬 수 있습니다.'}</Box>
							<Box mt={1} ml={2}>{'1. 가입 신청 시에 허위 이름, 이메일을 등록한 경우'}</Box>
							<Box mt={1} ml={2}>{'2. 다른 사람의 서비스 이용을 방해하거나 그 정보를 도용하는 경우'}</Box>
							<Box mt={1} ml={2}>{'3. 서비스를 이용하여 법령과 본 약관이 금지하거나 공서양속에 반하는 행위를 하는 경우'}</Box>
							<Box mt={1} ml={2}>{'4. 저작권법 및 컴퓨터프로그램보호법을 위반한 불법프로그램의 제공 및 운영방해, 정보통신망법을 위반한 불법통신 및 해킹, 악성프로그램의 배포, 접속권한 초과행위 등과 같이 관련법을 위반한 경우'}</Box>
						</Box>
					</ListItem>
				</List>
				<Typography variant={'h6'} component={'h6'}>
				...
				<List>
					<ListItem>
						<Box>
							...
							<Box mt={1} ml={2}>{'1. 커뮤니티 서비스(게시판)'}</Box>
						</Box>
					</ListItem>
					<ListItem>
				...
				<List>
					...
					<ListItem>
						<Box>
							<Box>{'② 제공된 개인정보는 당해 이용자의 동의없이 목적 외의 이용이나 제3자에게 제공할 수 없으며, 이에 대한 모든 책임은 개념글 저장소가 집니다. 다만, 다음의 경우에는 예외로 합니다.'}</Box>
							<Box mt={1} ml={2}>{'1. 통계작성, 학술연구 또는 시장조사를 위하여 필요한 경우로서 특정 개인을 식별할 수 없는 형태로 제공하는 경우'}</Box>
							<Box mt={1} ml={2}>{'2. 전기통신기본법 등 법률의 규정에 의해 국가기관의 요구가 있는 경우'}</Box>
							<Box mt={1} ml={2}>{'3. 범죄에 대한 수사상의 목적이 있거나 정보통신윤리 위원회의 요청이 있는 경우'}</Box>
							<Box mt={1} ml={2}>{'4. 기타 관계법령에서 정한 절차에 따른 요청이 있는 경우'}</Box>
						</Box>
					</ListItem>
					<ListItem>
				...
				<List>
					...
					<ListItem>
						<Box>
							...
							<Box mt={1} ml={2}>{'1. 다른 회원의 아이디(ID)를 부정 사용하는 행위'}</Box>
							<Box mt={1} ml={2}>{'2. 범죄행위를 목적으로 하거나 모든 범죄행위와 관련된 행위'}</Box>
							<Box mt={1} ml={2}>{'3. 선량한 풍속, 기타 사회질서를 해하는 행위'}</Box>
							<Box mt={1} ml={2}>{'4. 타인의 명예를 훼손하거나 모욕하는 행위'}</Box>
							<Box mt={1} ml={2}>{'5. 타인의 지적재산권 등의 권리를 침해하는 행위'}</Box>
							<Box mt={1} ml={2}>{'6. 음란물, 욕설 등 공서양속에 위반되는 내용의 정보, 문장, 도형 등을 유포하는 행위'}</Box>
							<Box mt={1} ml={2}>{'7. 저작권법 및 컴퓨터프로그램보호법을 위반한 불법프로그램의 제공 및 운영방해, 정보통신망법을 위반한 불법통신 및 해킹, 악성프로그램의 배포, 접속권한 초과행위 등과 같은 관련법 위반 행위'}</Box>
							<Box mt={1} ml={2}>{'8. 타인의 의사에 반하여 광고성 정보 등 일정한 내용을 지속적으로 전송 또는 타 사이트를 링크하는 행위'}</Box>
							<Box mt={1} ml={2}>{'9. 서비스의 안전적인 운영에 지장을 주거나 줄 우려가 있는 일체의 행위'}</Box>
							<Box mt={1} ml={2}>{'10. 기타 관계법령에 위배되는 행위'}</Box>
							<Box mt={1} ml={2}>{'11. 서비스를 통한 상업적 광고홍보 또는 상거래 행위'}</Box>
							<Box mt={1} ml={2}>{'12. 닉네임 또는 프로필 사진이 회원이나 제 3자의 개인정보를 포함하고 있는 경우'}</Box>
							<Box mt={1} ml={2}>{'13. 닉네임 또는 프로필 사진이 타인에게 혐오감을 주는 경우'}</Box>
							<Box mt={1} ml={2}>{'14. 닉네임 또는 프로필 사진이 욕설이나 범죄에 대한 내용이 포함된 경우'}</Box>
							<Box mt={1} ml={2}>{'15. 닉네임 또는 프로필 사진이 미풍양속에 반하는 경우'}</Box>
							<Box mt={1} ml={2}>{'16. 닉네임 또는 프로필 사진이 제3자를 비방하거나 분쟁을 야기하는 내용이 포함된 경우'}</Box>
						</Box>
					</ListItem>
				</List>
				<Typography variant={'h6'} component={'h6'}>
				...
				<List>
					<ListItem>
						<Box>
							<Box>{'① 게시물에 대한 저작권을 포함한 모든 권리 및 책임은 이를 게시한 회원에게 있습니다. 단, 개념글 저장소는 서비스의 운영, 전시, 전송, 배포, 홍보의 목적으로 회원의 별도의 허락 없이 무상으로 저작권법에 규정하는 공정한 관행에 합치되게 합리적인 범위 내에서 다음과 같이 회원이 등록한 게시물을 사용할 수 있습니다.'}</Box>
							<Box mt={1} ml={2}>{'1. 서비스 내에서 회원 게시물의 복제, 수정, 개조, 전시, 전송, 배포 및 저작물성을 해치지 않는 범위 내에서의 편집 저작물 작성'}</Box>
							<Box mt={1} ml={2}>{'2. 미디어, 통신사 등 서비스 제휴 파트너에게 회원의 게시물 내용을 제공, 전시 혹은 홍보하게 하는 것. 단, 이 경우 개념글 저장소는 별도의 동의 없이 회원의 이용자ID 외에 회원의 개인정보를 제공하지 않습니다.'}</Box>
						</Box>
					</ListItem>
				</List>
				<Typography variant={'h6'} component={'h6'}>
